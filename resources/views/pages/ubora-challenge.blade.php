...
<head>
    ...
    <title>
        Ubora Challenge | Wennovate Africa
    </title>
    ...
    <style>
        ...
        @media (min-width: 993px) {
            ...
            /* Hide mobile toggle components on desktop */
            .hamburger {
                display: none !important;
            }
        }
        ...
        @media (max-width: 992px) {
            ...
            /* Show state triggers the full-screen reveal */
            ...
            /* Staggered item reveal when menu is shown */
            ...
            /* Footer animates in when menu is shown */
            ...
            /* Social icon hover/active states */
            .mob-socials a:hover,
        ...
        /**
         * ============================================================
         * 6. RESPONSIVE STYLES FOR CONTENT
         * ============================================================
         */
        ...
        /**
         * ============================================================
         * 8. RESPONSIVE PATCHES FOR FOOTER
         * ============================================================
         */
        @media (max-width: 992px) {
            .footer-container {
...
<header id="topnav" class="defaultscroll sticky">
    <div class="container">
        ...
        <!-- Navigation (desktop centered, mobile full-screen overlay) -->
        <nav id="navigation" class="navigation-container">
            ...
            <ul class="navigation-menu">
                ...
                <li style="--i:4;"><a href="{{ url('/ubora-challenge') }}" class="nav-link active">Ubora Challenge</a></li>
                <li style="--i:5;"><a href="{{ url('/contact') }}" class="nav-link">Contact</a></li>
            </ul>

            <!-- Mobile menu footer: register button + social icons -->
...
<!-- ================= UBORA PAGE CONTENT ================= -->
<div class="ubora-page">

    <h1>Welcome to Ubora Challenge</h1>

    <p>
        The Ubora Challenge is a premier innovation competition designed to spotlight Africa's most
        promising entrepreneurs and problem-solvers. This is your opportunity to showcase your
        ideas, connect with industry leaders, and compete for life-changing opportunities.
    </p>

    <p>
        Participate in workshops, pitching sessions, and mentorship programs designed to help your
        idea grow from concept to reality. Join a community of innovators shaping Africa's future.
    </p>

    <a href="{{ url('/register') }}" class="ubora-cta">
 ...
 * document scrolling lock to match sponsor-partner.php behaviour.
 */
...
/* Particle class — golden floating dots */
class Particle {
    constructor() {
        this.reset();
    }
...
/* Initialise 50 floating particles */
...
/* Scroll handler — adds shadow to navbar when page is scrolled */
