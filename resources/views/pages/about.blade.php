...
<head>
    ...
    <title>About | Wennovate Africa</title>
    ...
    <div class="container">
        ...
        <nav id="navigation" class="navigation-container">
            ...
            <ul class="navigation-menu">
                ...
                <li style="--i:2;"><a href="{{ url('/about') }}" class="nav-link active">About</a></li>
...
window.addEventListener('scroll', function() {
    ...
    <style>
    /* Premium About Page Specific Styles */
    .about-hero {
        position: relative;
    ...
    .about-card:hover {
        ...
        box-shadow: 0 30px 60px rgba(106, 13, 173, 0.1);
        border-color: rgba(255, 215, 0, 0.3);
    }
    ...
    .about-classic-text {
        ...
        /* reveal-left css is already built in top css */
    }
    </style>

    <div class="about-hero" style="background: linear-gradient(rgba(10, 15, 63, 0.7), rgba(0, 0, 0, 0.8)), url('{{ asset('images/busi01.jpg') }}') center/cover fixed;">
        <h1 class="about-hero-title hero-typewriter" style="background: none; -webkit-text-fill-color: #fff; font-size: 4rem;" id="about-typewriter"></h1>
        <p class="about-hero-subtitle reveal" style="transition-delay: 0.2s; color: #cbd5e1; margin-top: 15px;">
            Driving technological and economic transformation across the continent.
        </p>
    </div>

    <div class="about-classic-section">
        <div class="about-classic-inner">
            <p class="about-classic-text reveal reveal-left" style="transition-delay: 0.1s;">
                Wennovate is a platform that connects African entrepreneurs, investors, policymakers and diaspora networks working across innovation ecosystems.
            </p>

            <p class="about-classic-text reveal reveal-left" style="transition-delay: 0.2s;">
                Over the past three years, Wennovate has convened a series of innovation and investment dialogues in Oslo, Norway, bringing together African founders, Nordic investors and policymakers. These events were organised in partnership with the Embassy of Ethiopia to the Nordics, the Ethiopian Ministry of Innovation and Technology, and the Ethiopian Ministry of Investment, (Others??... who) among other ecosystem actors.
            </p>
            
            <p class="about-classic-text reveal reveal-left" style="transition-delay: 0.3s;">
                The Wennovate Africa Summit builds on these engagements and brings the conversation to the continent, creating a platform for investment, collaboration and dialogue around Africa’s growing startup ecosystems.
            </p>
        </div>
    </div>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            setTimeout(() => {
                function writeLetter() {
                    if (idx < text.length) {
                        el.innerHTML += text.charAt(idx) === " " ? "&nbsp;" : text.charAt(idx);
                        idx++;
                        setTimeout(writeLetter, 120); // typing speed
                    } else {
                        // remove the blinking cursor once finished
                        el.classList.remove("hero-typewriter");
                    }
                }
                writeLetter();
            }, 600);
