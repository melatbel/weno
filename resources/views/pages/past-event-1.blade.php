{{-- Past Event 1 - Hack Africa Hackathon 2020 --}}

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Portfolio Detail - Wennovate Africa</title>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Poppins:wght@400;500;600;700&display=swap"
        rel="stylesheet"
    >
    ...
    <style>
        ...
        .event-title-container .event-date {
            font-size: 20px;
            font-weight: 500;
            color: #555;
            display: block;
        ...
        @media (max-width: 768px) {
            ...
            .event-title-container h1 { font-size: 32px; }
            .description-text { font-size: 17px; padding: 0 10px; }
        }

        @media (max-width: 480px) {
            .hero-img { height: 200px; margin-top: 80px; }
            .event-title-container h1 { font-size: 26px; }
            .description-text { font-size: 15px; }
        }

        /**
         * ============================================================
         * 7. ULTRA-ADVANCED SINGLE ROW FOOTER CSS
         * ============================================================
         */
        .footer {
            background: #050510;
        ...
        @keyframes wave {
            ...
            50% { transform: translateX(25%) translateY(10px) rotate(3deg); }
        }
        ...
        /* text shadow removed for transparent gradient */
            100% { text-shadow: 0 0 30px rgba(59,130,246,1), 0 0 60px rgba(59,130,246,0.6); }
        }
        ...
        .footer-newsletter { flex: 1.5; }

        .footer-newsletter p { font-size: 1.1rem; margin-bottom: 20px; opacity: 0.9; }
        ...
        /**
         * ============================================================
         * 8. RESPONSIVE FOOTER PATCHES
         * ============================================================
         */
        @media (max-width: 1200px) {
            .footer-container { flex-wrap: wrap; justify-content: flex-start; }
            .footer-brand, .footer-newsletter { flex: 1 1 100%; margin-bottom: 30px; }
        }
...
<section class="container py-5">
    <div class="hero-img mb-4" data-aos="fade-up" data-aos-duration="1200">
        <img src="{{ asset('images/contact-detail.jpg') }}" alt="Hero Image">
    </div>

    <div class="event-title-container" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
        <h1>Hack Africa — The Hackathon / Digital African Innovation 2020</h1>
        <span class="event-date">May 2020</span>
    </div>

    <div class="description-text" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
        Intensive multi-week / 3-day hack formats delivered <span>88 solutions</span> from participants across
        <span>47 countries</span> and <span>six continents</span>, supported by <span>40 mentors</span> and
        producing <span>200+ participants</span> with a strong online reach.
        Side activities included a textile &amp; leather fashion show, workshops, and follow-up initiatives.
        Support innovation, connect with leaders, and grow your brand alongside us.
    </div>

    <div class="row g-4 mb-4">
        @for ($i = 1; $i <= 9; $i++)
        <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="{{ $i * 100 }}">
            <div class="gallery-card">
                <img src="{{ asset('images/contact-detail.jpg') }}" alt="Gallery Image {{ $i }}">
            </div>
        </div>
        @endfor
    </div>
