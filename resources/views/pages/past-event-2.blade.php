{{-- Past Event 2 - Wennovate Africa Nordic Dialogue 2023-2025 --}}
...
<section class="container py-5">
    ...
    <div class="event-title-container" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
        <h1>Wennovate Africa – Nordic Dialogue / Oslo Innovation Week</h1>
        <span class="event-date">2023 – 2025 (incl. 2025 participation)</span>
    </div>

    <!-- CREATIVE DESCRIPTION -->
    <div class="description-text" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
        Regional dialogue series and partnership platform connecting <span>Nordic ecosystems</span> with
        <span>African innovators</span> — designed to promote <span>policy exchange</span>,
        <span>collaboration</span>, and <span>investor linkages</span> between the Nordics and Africa.
    </div>
